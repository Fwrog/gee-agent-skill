...
def test_plan_from_text_accepts_ndbi_csv():
    ...
    assert plan["validation"]["rulesets"] == ["global_safety", "builtup_index_ndbi"]
...
def test_plan_from_text_accepts_landsat_lst_csv():
    ...
    assert plan["validation"]["rulesets"] == ["global_safety", "landsat_lst"]
...
def test_plan_from_text_accepts_sentinel1_flood_before_after():
    ...
    assert plan["validation"]["rulesets"] == ["global_safety", "sentinel1_flood_before_after"]
