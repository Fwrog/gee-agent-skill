...
PYTHONPATH=src .venv/bin/python -m geeskill.cli catalog evidence --category operator --json
PYTHONPATH=src .venv/bin/python -m geeskill.cli catalog evidence --category failure --json
