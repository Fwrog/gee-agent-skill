...
- v0.3 Hong Kong NDVI product intercomparison is Golden: the committed evidence covers full-year 2024 CSV and annual GeoTIFF Drive readback, local raster QA, figures, report, tests, and the readiness audit. This status is product-level consistency evidence, not in-situ validation.
