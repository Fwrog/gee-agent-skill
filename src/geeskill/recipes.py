...
FALLBACK_RECIPES: tuple[Recipe, ...] = (
    ...
    Recipe(
        ...
        candidate_datasets=(
            ...
            "external/annual-categorical-landcover",
        ),
        ...
        output_schema=(
            ...
            "export_task_description",
        ),
        live_risk_level="high",
        examples=("Build annual transition probabilities for a reviewed multi-year AOI on a fixed equal-area grid.",),
        limitations=(
            "The recipe is generic render-and-validate capability and has no public live-export evidence.",
            "Endpoint thresholds, class codes, activity coverage, and private-asset permissions require study-specific review.",
            "Joining VIIRS ANNUAL_V21 and ANNUAL_V22 requires an explicit cross-version policy; ANNUAL_V22 alone does not cover years before 2022.",
            "Classifier probability near 0.5 is model ambiguity unless independently supported as spatial mixture.",
        ),
    ),
    Recipe(
